...
if($u != $log_username){
	header("location: chat&".$log_username."");
    exit();
}
if($state != "log"){
...
<body class="hold-transition skin-blue fixed mobile-only-show">
    ...
    <nav class="navbar navbar-static-top">
	  ...
	  <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
	       ...
	       <li class="dropdown messages-menu mobile-only-show">
				<a class="dropdown-toggle hand">
      ...
      <div class="row">
		...
		<?php include_once("_ext/_def/default-chat-right-col.php");?>
			<div class="box box-primary direct-chat direct-chat-primary">
				<div class="box-header with-border msg_box_head_hover">		
					<h3 class="box-title">Chat</h3></div><div class="box-body">
						<ul id="chat_note_mobile" class="contacts-list">
							<?php echo $chatListMobile;?>
						</ul>
				</div>
			</div>
		</div>
